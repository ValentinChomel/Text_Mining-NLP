...
d2v_vecs = np.concatenate([d2v_dm_vecs, d2v_dbow_vecs],axis=1) #following best practice
...
for idx,doc in enumerate(cleaned_docs[-n_left_out:]):
    ## fill the gap ## call the infer_vector method on the two models. Save results as 'to_add'
