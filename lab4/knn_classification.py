...
## fill the gap ## note: w2v.wv.vocab returns a dictionary
...
w2v.intersect_word2vec_format(path_to_google_news + 'GoogleNews-vectors-negative300.bin', binary=True) #possible de garder .gz
...
for nn in [1,3,5,7,11,13,15,17,21,23]:
    ...
    for idx,sims in enumerate(my_centroid_similarities):
        ...
        ### fill gap ### get labels of 'nn' nearest neighbors. Be cautious about the difference between distance and similarity! --> distance = 1/similarity
